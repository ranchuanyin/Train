<template>
    ...
    <a-modal v-model:visible="visible" cancel-text="取消" ok-text="确认"
             title="火车车站" @ok="handleOk">
        <a-form :label-col="{span: 4}" :model="trainStation" :wrapper-col="{ span: 20 }">
            ...
            <a-form-item label="进站时间">
                <a-time-picker v-model:value="trainStation.inTime" placeholder="请选择时间" valueFormat="HH:mm:ss"/>
            </a-form-item>
            <a-form-item label="出站时间">
                <a-time-picker v-model:value="trainStation.outTime" placeholder="请选择时间" valueFormat="HH:mm:ss"/>
            </a-form-item>
            <a-form-item label="停站时长">
                <a-time-picker v-model:value="trainStation.stopTime" disabled placeholder="请选择时间"
