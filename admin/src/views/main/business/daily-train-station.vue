<template>
    ...
    <a-modal v-model:visible="visible" cancel-text="取消" ok-text="确认"
             title="每日车站" @ok="handleOk">
        <a-form :label-col="{span: 4}" :model="dailyTrainStation" :wrapper-col="{ span: 20 }">
            <a-form-item label="日期">
                <a-date-picker v-model:value="dailyTrainStation.date" placeholder="请选择日期"
            ...
            <a-form-item label="进站时间">
                <a-time-picker v-model:value="dailyTrainStation.inTime" placeholder="请选择时间"
                               valueFormat="HH:mm:ss"/>
            </a-form-item>
            <a-form-item label="出站时间">
                <a-time-picker v-model:value="dailyTrainStation.outTime" placeholder="请选择时间"
                               valueFormat="HH:mm:ss"/>
            </a-form-item>
            <a-form-item label="停站时长">
                <a-time-picker v-model:value="dailyTrainStation.stopTime" disabled
                               placeholder="请选择时间" valueFormat="HH:mm:ss"/>
            </a-form-item>
