<template>
    ...
    <a-modal v-model:visible="visible" cancel-text="取消" ok-text="确认"
             title="每日车箱" @ok="handleOk">
        <a-form :label-col="{span: 4}" :model="dailyTrainCarriage" :wrapper-col="{ span: 20 }">
            <a-form-item label="日期">
                <a-date-picker v-model:value="dailyTrainCarriage.date" placeholder="请选择日期"
