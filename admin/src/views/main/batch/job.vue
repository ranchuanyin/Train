<template>
    <div class="job">
            ...
            <template #bodyCell="{ column, record }">
                <template v-if="column.dataIndex === 'operation'">
                    <a-space>
                        ...
                        >
                            <a-button v-show="record.state === 'PAUSED' || record.state === 'ERROR'" size="small"
                                      type="primary">
                                重启
                            </a-button>
                        </a-popconfirm>
                        ...
                        >
                            <a-button v-show="record.state === 'NORMAL' || record.state === 'BLOCKED'" size="small"
                                      type="primary">
                                暂停
                            </a-button>
                        </a-popconfirm>
        ...
        <a-modal
                ...
                @ok="handleModalOk"
        >
            <a-form :label-col="{ span: 6 }" :model="job" :wrapper-col="{ span: 18 }">
