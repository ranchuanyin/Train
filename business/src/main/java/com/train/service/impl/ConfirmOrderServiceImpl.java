...
public class ConfirmOrderServiceImpl extends ServiceImpl<ConfirmOrderMapper, ConfirmOrder>
    ...
    public PageResp<ConfirmOrderQueryResp> queryList(ConfirmOrderQueryReq req) {
        ...
        List<ConfirmOrder> confirmOrderList = confirmOrderMapper.selectList(wrapper);
    ...
    public void doConfirm(ConfirmOrderMQDto dto) {
        ...
        try {
            ...
            while (true) {
                ...
                List<ConfirmOrder> list = confirmOrderMapper.selectList(wrapper);
    ...
    public Integer queryLineCount(Long id) {
        ...
        if (result == 999) {
            LambdaQueryWrapper<ConfirmOrder> wrapper = new LambdaQueryWrapper<>();
            wrapper.nested(i -> i.eq(ConfirmOrder::getDate, confirmOrder.getDate()).eq(ConfirmOrder::getTrainCode, confirmOrder.getTrainCode())
                            .eq(ConfirmOrder::getCreateTime, confirmOrder.getCreateTime()).eq(ConfirmOrder::getStatus, ConfirmOrderStatusEnum.INIT.getCode())).or()
                    .nested(i -> i.eq(ConfirmOrder::getDate, confirmOrder.getDate()).eq(ConfirmOrder::getTrainCode, confirmOrder.getTrainCode())
                            .eq(ConfirmOrder::getCreateTime, confirmOrder.getCreateTime()).eq(ConfirmOrder::getStatus, ConfirmOrderStatusEnum.PENDING.getCode()));
    ...
    public Integer cancel(Long id) {
        LambdaQueryWrapper<ConfirmOrder> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(ConfirmOrder::getId, id).eq(ConfirmOrder::getStatus, ConfirmOrderStatusEnum.INIT.getCode());
        ConfirmOrder confirmOrder = new ConfirmOrder();
        confirmOrder.setStatus(ConfirmOrderStatusEnum.CANCEL.getCode());
        return confirmOrderMapper.update(confirmOrder, wrapper);
    }
}
